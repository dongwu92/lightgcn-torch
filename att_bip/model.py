...
from att_layer import SpGraphAttentionLayer as AttLayer
...
# random normal init seems to be a better choice when lightGCN actually don't use any non-linear activation function
        ...
        self.f = nn.Sigmoid()
        self.Graph, self.Edge = self.dataset.getSparseGraph()
        self.Layers = []
        for i in range(self.n_layers):
            self.Layers.append(AttLayer(self.latent_dim, self.latent_dim, 0.6, 0.2)) # TODO
    ...
    def computer(self):
        ...
        for layer in range(self.n_layers):
            if self.A_split:
                ...
                all_emb = self.Layers[layer](all_emb, g_droped, self.Edge)
            embs.append(all_emb)
